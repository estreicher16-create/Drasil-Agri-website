...
const PRODUCT_DATA = [
  ...
  },
  {
    ...
    bullets: [
      "Budget tracker — every expense, every list, balance with a real-time total.",
      "Price comparison to find the best deal across products.",
      "Loyalty cards — every card in one place, instant access at the till.",
      "Shared lists — coordinate with family with real-time sync.",
      "Meal planner that organises your week and generates recipes.",
      "Spending analytics — visualise history and review your habits. 7-day free trial.",
    ],
    hue: 340,
    Mockup: KarttlyMockup,
    image: "assets/karttly-infographic.png",
    status: "LIVE",
    region: "INTERNATIONAL",
  ...
  },
  {
    ...
    bullets: [
      "Professional quotes — instant job specs in your branding.",
      "Field service — track on-site jobs from quote through to paid.",
      "Stock control with intelligent reorder suggestions.",
      "VAT-ready invoices with accurate Rand totals, ready for SARS.",
      "Small Retail / POS — barcode scanning and end-of-day cash-up.",
      "One app. Total business visibility. Join the beta — free trial available.",
    ],
    hue: 200,
    Mockup: TradeWorxMockup,
    image: "assets/tradeworx-infographic.png",
    status: "90% — JOIN BETA",
